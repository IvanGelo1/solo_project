...
function LighthouseSvg() {
  return (
    ...
    >
      ...
      />
      <Path
        d="M200.95 472.86H453.2a35.77 35.77 0 01-35.77 35.77H236.72a35.77 35.77 0 01-35.77-35.77zM200.95 295H453.2a35.77 35.77 0 01-35.77 35.77H236.72A35.77 35.77 0 01200.95 295z"
        fill="#00bfa6"
      />
      ...
      />
      <Path
        d="M377.9 672.4h-59.3v-81.42a29.65 29.65 0 0129.65-29.65 29.66 29.66 0 0129.65 29.65z"
        fill="#e0e0e0"
      />
      <Path
        d="M883.33 707.22H.46s57-131 143.4-154.18a98.17 98.17 0 0138.27-2.71c20.84 2.65 39.69 13.58 53.08 29.77 28.32 34.24 115.05 108.85 288.58 23.59 0 0 62.12-62.12 161.89 11.29a191.58 191.58 0 0019 8.2c30.61 11.57 91.84 27.69 135.37-6.32 60.23-47.06 43.28 90.36 43.28 90.36z"
        fill="#4d8af0"
      />
      <G opacity={0.3} fill="#e0e0e0">
        <Rect
      ...
      <G opacity={0.3} fill="#030b44">
        <Path d="M634.85 259.2h32.94s-12.41 21.96-32.94 0z" />
        <Path d="M636.84 268.54l21.6-24.87s8.44 23.77-21.6 24.87z" />
      </G>
      <G opacity={0.3} fill="#030b44">
        <Path d="M517.2 327.91h32.94s-12.41 21.96-32.94 0z" />
        <Path d="M519.19 337.25l21.59-24.87s8.45 23.77-21.59 24.87z" />
      </G>
      <G opacity={0.3} fill="#030b44">
        <Path d="M474.59 70.01h35.33s-13.31 23.6-35.33 0z" />
        <Path d="M476.72 80.04l23.17-26.69s9.06 25.5-23.17 26.69z" />
      </G>
      <Path
      ...
      />
      <Path
        d="M935.06 460.17a1.5 1.5 0 000-3 1.5 1.5 0 000 3z"
        fill="#4d8af0"
      />
      <Path
